...
// 
@Repository(value = "cn.hualuomoli.mp.nideshop.base.mapper.ChannelBaseMapper")
public interface ChannelBaseMapper {

  /** 根据主键id查询 */
  Channel get(java.lang.Integer id);

  /** 添加 */
  int insert(Channel channel);

  /** 批量添加 */
  <T extends Channel> int batchInsert(@Param(value = "list") List<T> list);
